    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100 p-4">
      <div className="w-full max-w-md space-y-6">
        <div className="text-center space-y-2">
          <h1 className="text-3xl font-bold text-gray-900">Rede APOGEU</h1>
          <p className="text-lg text-gray-600">Avaliação Docente</p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Entre com sua conta para acessar o formulário de feedback
            </CardDescription>
          </CardHeader>
